...
import styles from "./IncorrectRecipes.module.css";
import TableData from "../tableData/TableData";
import spinner from "../../assets/spinner.gif";
import Pagination from "../pagination/Pagination";
function IncorrectRecipes() {
  ...
  useEffect(() => {
    fetch(
      `https://beta.eagleowl.in/api/v1/mock/organization/18/outlet/18/recipe/recipes/?page=${currentPage}&is_incorrect=true`
    )
      .then((res) => res.json())
      .then((data) => {
        if (data) {
...
export default IncorrectRecipes;
